//
//  NSAttributedString+jd_convenience.m
//  JDFoundation
//
...
@implementation NSAttributedString (jd_convenience)
...
- (CGFloat)heightWithFont:(UIFont *)font lineSpacing:(CGFloat)lineSpacing constrainedToWidth:(CGFloat)maxWidth lineCount:(NSUInteger)maxLineCount {
    return [self heightWithFont:font lineSpacing:lineSpacing firstLineHeadIndent:0.0f constrainedToWidth:maxWidth lineCount:maxLineCount];
}
